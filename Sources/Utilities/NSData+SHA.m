...
- (NSData*) HDKFSHA256ExpandWithInfo: (NSData*) info length: (NSUInteger) length
{
	...
	{
		tn = [NSMutableData dataWithData: tn];
		[tn appendData: info];
		unsigned char n = i + 1;
		[tn appendBytes: &n length: 1];
		tn = [NSMutableData dataWithData: [tn HMACSHA256WithKey: self]];
